...
class NoteDetails extends StatefulWidget {
  ...
  const NoteDetails({Key? key, this.noteModel, this.isAdd}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  WillPopScope(
        onWillPop: () async {
          ...
          // final  notes = Provider.of<AppStateNotifier>(context);
          // notes.setNotes();
          return true;
        },
        child: Scaffold(
              ...
              children: [
                Text(
                  widget.isAdd == true
                      ...
                      : "${widget.noteModel!.createdNoteAt}",
                  style: Theme.of(context).textTheme.headline3,
                ),
                SizedBox(
                  height: 10,
