...
class _DictionHistoryState extends State<DictionHistory> {
  ...
  Future<bool> _onWillPop() async {
    await  Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (_) => DictionHomePage(),));
    return true ;
  }
  @override
              ...
              PopupMenuButton(
                  ...
                  itemBuilder: (context) => <PopupMenuEntry>[
                        PopupMenuItem(
                          value: 1,
                            child: ListTile(
                          title: Text("Clear ${LocalSave.recent}", style: Theme.of(context).textTheme.headline3),
              ...
              child: dictionaryController.recentWORDs.length == 0
                  ? Container(
                    child: Column(
                      ...
                      children: [
                        Center(
                            child: Icon(Icons.timelapse_outlined, color: Theme.of(context).iconTheme.color, size: 200,)
                        ),
                        SizedBox(height: 20,),
                        Center(
                          child: Text(
...
separatorBuilder: (_, __)=> Divider(height: 0.5,),
                      ...
                      itemBuilder: (context, index) {
                        WordModel wordModel = dictionaryController.getHistory[index];
                        return Dismissible(
                          child: ListTile(
                          ...
                          onDismissed: (direction) async{
                            ...
                            if (direction == DismissDirection.endToStart){
                            ...
                            else
                              {
                                ...
                                await dictionaryController.addFavWORD(wordModel);
                               ...
                               res = await showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      backgroundColor: Theme.of(context).backgroundColor,
                                      content: Text(
                                          "Are you sure you want to delete ${DictionFunctions.capitalise(wordModel.wordName)}?", style: Theme.of(context).textTheme.headline3),
                                      actions: <Widget>[
                                        TextButton(
                                          child: Text(
                                            "Cancel",
                               ...
                               res = await showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      backgroundColor: Theme.of(context).backgroundColor,
                                      content: Text(
                                          "Are you sure you want to save ${DictionFunctions.capitalise(wordModel.wordName)}?", style: Theme.of(context).textTheme.headline3,),
                                      actions: <Widget>[
                                        TextButton(
                                          child: Text(
                                            "Cancel",
                                        ...
                                        TextButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await dictionaryController.addFavWORD(
                                                wordModel);
                                             ScaffoldMessenger.of(
                                                      ...
                                                      content: Text(
                                                          "Saved ${wordModel.wordName} to Favourites"),
                                                    ));
                                            Navigator.of(context).pop();
                                          },
                                        ),
