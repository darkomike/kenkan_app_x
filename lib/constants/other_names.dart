...
class LinkNames {
  static final String toEmail = 'mailto:mikdik76@gmail.com';
  static final String toTwitter = 'https://www.twitter.com/IntelliSense7';
  static final String toInstagram = 'https://www.instagram.com/@intelsense7';
  static final String toFacebook = 'https://www.facebook.com/michael.darko.714';
  static final String toGoogle = 'https://www.google.com/search?q=';
  static final String toSms = 'sms:+233 551167889';
  static final String toTelephone = 'tel:+233 551167889';
}
...
class BodyNames {
  ...
  static final String feedbackMessageBody =
      ...
      "contact via the following means and we will try to figure it out.";
}
